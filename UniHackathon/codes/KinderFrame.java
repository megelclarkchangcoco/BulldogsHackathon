...
public class KinderFrame extends JFrame {

	private static final long serialVersionUID = 1L;
	private JPanel contentPane;
	private JPanel ChoicesPanel_1,ChoicesPanel_3;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					KinderFrame frame = new KinderFrame();
	...
	public KinderFrame() {
		...
		JPanel headerPanel = new JPanel() {
            ...
            {
                // Load the icon image
                icon = new ImageIcon("C:\\Users\\megel\\eclipse-workspace\\Unitour\\img\\img\\plant.png").getImage();
            }
		...
		headerPanel.setBounds(75, 22, 181, 178);
		...
		JLabel lblNewLabel = new JLabel("Basic Planting");
...
//		    @Override
//		    public void mouseClicked(MouseEvent e) {
//		    	ChoicesPanel_1.setBounds(229, 450, 402, 265);
//		    	ChoicesPanel_1.setVisible(true);
//		    }
//
//		    @Override
//		    public void mouseEntered(MouseEvent e) {
...
//		
//		ChoicesPanel_1 = new JPanel();
//		ChoicesPanel_1.addMouseListener(new MouseAdapter() {
//		    @Override
//		    public void mouseExited(MouseEvent e) {
//		    	ChoicesPanel_1.setBounds(229, 450, 402, 2);
//		    	ChoicesPanel_1.setVisible(false);
//		    }
//		});
//		ChoicesPanel_1.setBorder(new LineBorder(new Color(0, 0, 0)));
//		ChoicesPanel_1.setBackground(new Color(15, 184, 74));
//		ChoicesPanel_1.setBounds(229, 450, 402, 2);
//		ChoicesPanel_1.setVisible(false);
//		panel.add(ChoicesPanel_1);
//		ChoicesPanel_1.setLayout(null);
		...
		JPanel headerPanel_2 = new JPanel() {
            ...
            {
                // Load the icon image
                icon = new ImageIcon("C:\\Users\\megel\\eclipse-workspace\\Unitour\\img\\img\\heart.png").getImage();
            }
		...
		JLabel lblNewLabel_2 = new JLabel("Social Etiquette");
